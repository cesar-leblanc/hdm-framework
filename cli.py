...
def _add_rfc_parser(parser):
    ...
    group_rfc.add_argument('--warm_start', type=bool_type, default=False, help='The choice to reuse the solution of the previous call to fit and add mor estimators to the ensemble or to just fit a whole new forest.')
...
def _add_tnc_parser(parser):
    ...
    group_tnc.add_argument('--scheduler_params', type=dict, default={"step_size": 10, "gamma": 0.9}, help='The dictionnary of parameters to apply to the PyTorch scheduler.')
...
def _add_miscellaneous_parser(parser):
    ...
    group_miscellaneous.add_argument('--write_bytecode', type=bool_type, default=False, help='The choice to able or disable bytecode generation.')
    group_miscellaneous.add_argument('--disable_warnings', type=bool_type, default=True, help='The choice to able or disable warnings.')
